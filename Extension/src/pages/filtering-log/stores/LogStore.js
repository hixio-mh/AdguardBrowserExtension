    ...
    filters: [
        {
            ...
            title: '1P',
            enabled: true,
            tooltip: reactTranslator.getMessage('filtering_log_first_party_tag_tooltip'),
        },
        {
            id: REQUEST_SOURCE_FILTERS.THIRD_PARTY,
            title: '3P',
            enabled: true,
            tooltip: reactTranslator.getMessage('filtering_log_third_party_tag_tooltip'),
        },
    ],
};
    ...
    filters: [
        {
            ...
            enabled: true,
            tooltip: reactTranslator.getMessage('filtering_log_html_tag_tooltip'),
        },
        {
            ...
            enabled: true,
            tooltip: reactTranslator.getMessage('filtering_log_css_tag_tooltip'),
        },
        {
            ...
            enabled: true,
            tooltip: reactTranslator.getMessage('filtering_log_js_tag_tooltip'),
        },
        {
            ...
            enabled: true,
            tooltip: reactTranslator.getMessage('filtering_log_xhr_tag_tooltip'),
        },
        {
            ...
            enabled: true,
            tooltip: reactTranslator.getMessage('filtering_log_img_tag_tooltip'),
        },
        {
            ...
            enabled: true,
            tooltip: reactTranslator.getMessage('filtering_log_media_tag_tooltip'),
        },
        {
            ...
            enabled: true,
            tooltip: reactTranslator.getMessage('filtering_log_other_tag_tooltip'),
        },
    ],
};
